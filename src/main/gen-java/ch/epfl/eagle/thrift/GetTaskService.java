...
public class GetTaskService {
  ...
  public interface Iface {
    ...
    public List<ch.epfl.eagle.thrift.TTaskLaunchSpec> getTask(String requestId, ch.epfl.eagle.thrift.THostPort nodeMonitorAddress, ch.epfl.eagle.thrift.THostPort oldNodeMonitorAddress) throws org.apache.thrift.TException;

  }

  public interface AsyncIface {

    public void getTask(String requestId, ch.epfl.eagle.thrift.THostPort nodeMonitorAddress, ch.epfl.eagle.thrift.THostPort oldNodeMonitorAddress, org.apache.thrift.async.AsyncMethodCallback resultHandler) throws org.apache.thrift.TException;
  ...
  public static class Client extends org.apache.thrift.TServiceClient implements Iface {
    ...
    public List<ch.epfl.eagle.thrift.TTaskLaunchSpec> getTask(String requestId, ch.epfl.eagle.thrift.THostPort nodeMonitorAddress, ch.epfl.eagle.thrift.THostPort oldNodeMonitorAddress) throws org.apache.thrift.TException
    {
      send_getTask(requestId, nodeMonitorAddress, oldNodeMonitorAddress);
      return recv_getTask();
    }

    public void send_getTask(String requestId, ch.epfl.eagle.thrift.THostPort nodeMonitorAddress, ch.epfl.eagle.thrift.THostPort oldNodeMonitorAddress) throws org.apache.thrift.TException
    {
      getTask_args args = new getTask_args();
      args.setRequestId(requestId);
      args.setNodeMonitorAddress(nodeMonitorAddress);
      args.setOldNodeMonitorAddress(oldNodeMonitorAddress);
      sendBase("getTask", args);
    }

    public List<ch.epfl.eagle.thrift.TTaskLaunchSpec> recv_getTask() throws org.apache.thrift.TException
    {
  ...
  public static class AsyncClient extends org.apache.thrift.async.TAsyncClient implements AsyncIface {
    ...
    public void getTask(String requestId, ch.epfl.eagle.thrift.THostPort nodeMonitorAddress, ch.epfl.eagle.thrift.THostPort oldNodeMonitorAddress, org.apache.thrift.async.AsyncMethodCallback resultHandler) throws org.apache.thrift.TException {
      checkReady();
      getTask_call method_call = new getTask_call(requestId, nodeMonitorAddress, oldNodeMonitorAddress, resultHandler, this, ___protocolFactory, ___transport);
    ...
    public static class getTask_call extends org.apache.thrift.async.TAsyncMethodCall {
      ...
      private ch.epfl.eagle.thrift.THostPort nodeMonitorAddress;
      private ch.epfl.eagle.thrift.THostPort oldNodeMonitorAddress;
      public getTask_call(String requestId, ch.epfl.eagle.thrift.THostPort nodeMonitorAddress, ch.epfl.eagle.thrift.THostPort oldNodeMonitorAddress, org.apache.thrift.async.AsyncMethodCallback resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
        super(client, protocolFactory, transport, resultHandler, false);
        this.requestId = requestId;
        this.nodeMonitorAddress = nodeMonitorAddress;
        this.oldNodeMonitorAddress = oldNodeMonitorAddress;
      }
      ...
      public List<ch.epfl.eagle.thrift.TTaskLaunchSpec> getResult() throws org.apache.thrift.TException {
  ...
  public static class Processor<I extends Iface> extends org.apache.thrift.TBaseProcessor<I> implements org.apache.thrift.TProcessor {
    ...
    public static class getTask<I extends Iface> extends org.apache.thrift.ProcessFunction<I, getTask_args> {
      ...
      public getTask_result getResult(I iface, getTask_args args) throws org.apache.thrift.TException {
        getTask_result result = new getTask_result();
        result.success = iface.getTask(args.requestId, args.nodeMonitorAddress, args.oldNodeMonitorAddress);
        return result;
      }
    }
  ...
  public static class AsyncProcessor<I extends AsyncIface> extends org.apache.thrift.TBaseAsyncProcessor<I> {
    ...
    public static class getTask<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, getTask_args, List<ch.epfl.eagle.thrift.TTaskLaunchSpec>> {
      public getTask() {
        super("getTask");
      }
      ...
      public AsyncMethodCallback<List<ch.epfl.eagle.thrift.TTaskLaunchSpec>> getResultHandler(final AsyncFrameBuffer fb, final int seqid) {
        final org.apache.thrift.AsyncProcessFunction fcall = this;
        return new AsyncMethodCallback<List<ch.epfl.eagle.thrift.TTaskLaunchSpec>>() { 
          public void onComplete(List<ch.epfl.eagle.thrift.TTaskLaunchSpec> o) {
            getTask_result result = new getTask_result();
            result.success = o;
            try {
      ...
      public void start(I iface, getTask_args args, org.apache.thrift.async.AsyncMethodCallback<List<ch.epfl.eagle.thrift.TTaskLaunchSpec>> resultHandler) throws TException {
        iface.getTask(args.requestId, args.nodeMonitorAddress, args.oldNodeMonitorAddress,resultHandler);
      }
    }
  ...
  public static class getTask_args implements org.apache.thrift.TBase<getTask_args, getTask_args._Fields>, java.io.Serializable, Cloneable, Comparable<getTask_args>   {
    ...
    private static final org.apache.thrift.protocol.TField OLD_NODE_MONITOR_ADDRESS_FIELD_DESC = new org.apache.thrift.protocol.TField("oldNodeMonitorAddress", org.apache.thrift.protocol.TType.STRUCT, (short)3);
    ...
    public ch.epfl.eagle.thrift.THostPort nodeMonitorAddress; // required
    public ch.epfl.eagle.thrift.THostPort oldNodeMonitorAddress; // required

    /** The set of fields this struct contains, along with convenience methods for finding and manipulating them. */
    public enum _Fields implements org.apache.thrift.TFieldIdEnum {
      REQUEST_ID((short)1, "requestId"),
      NODE_MONITOR_ADDRESS((short)2, "nodeMonitorAddress"),
      OLD_NODE_MONITOR_ADDRESS((short)3, "oldNodeMonitorAddress");
      ...
      public static _Fields findByThriftId(int fieldId) {
        switch(fieldId) {
          ...
          case 3: // OLD_NODE_MONITOR_ADDRESS
            return OLD_NODE_MONITOR_ADDRESS;
          default:
            return null;
        }
      }
    ...
    static {
      ...
      tmpMap.put(_Fields.NODE_MONITOR_ADDRESS, new org.apache.thrift.meta_data.FieldMetaData("nodeMonitorAddress", org.apache.thrift.TFieldRequirementType.DEFAULT, 
          new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, ch.epfl.eagle.thrift.THostPort.class)));
      tmpMap.put(_Fields.OLD_NODE_MONITOR_ADDRESS, new org.apache.thrift.meta_data.FieldMetaData("oldNodeMonitorAddress", org.apache.thrift.TFieldRequirementType.DEFAULT, 
          new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, ch.epfl.eagle.thrift.THostPort.class)));
    ...
    public getTask_args(
      String requestId,
      ch.epfl.eagle.thrift.THostPort nodeMonitorAddress,
      ch.epfl.eagle.thrift.THostPort oldNodeMonitorAddress)
    {
      this();
      this.requestId = requestId;
      this.nodeMonitorAddress = nodeMonitorAddress;
    ...
    public getTask_args(getTask_args other) {
      ...
      if (other.isSetNodeMonitorAddress()) {
        this.nodeMonitorAddress = new ch.epfl.eagle.thrift.THostPort(other.nodeMonitorAddress);
      }
      if (other.isSetOldNodeMonitorAddress()) {
        this.oldNodeMonitorAddress = new ch.epfl.eagle.thrift.THostPort(other.oldNodeMonitorAddress);
      }
    }
    ...
    public void clear() {
      ...
      this.oldNodeMonitorAddress = null;
    }
    ...
    public ch.epfl.eagle.thrift.THostPort getNodeMonitorAddress() {
      return this.nodeMonitorAddress;
    }

    public getTask_args setNodeMonitorAddress(ch.epfl.eagle.thrift.THostPort nodeMonitorAddress) {
      this.nodeMonitorAddress = nodeMonitorAddress;
      return this;
    }
    ...
    public ch.epfl.eagle.thrift.THostPort getOldNodeMonitorAddress() {
      return this.oldNodeMonitorAddress;
    }

    public getTask_args setOldNodeMonitorAddress(ch.epfl.eagle.thrift.THostPort oldNodeMonitorAddress) {
      this.oldNodeMonitorAddress = oldNodeMonitorAddress;
      return this;
    }

    public void unsetOldNodeMonitorAddress() {
      this.oldNodeMonitorAddress = null;
    }

    /** Returns true if field oldNodeMonitorAddress is set (has been assigned a value) and false otherwise */
    public boolean isSetOldNodeMonitorAddress() {
      return this.oldNodeMonitorAddress != null;
    }

    public void setOldNodeMonitorAddressIsSet(boolean value) {
      if (!value) {
        this.oldNodeMonitorAddress = null;
      }
    }
    ...
    public void setFieldValue(_Fields field, Object value) {
      ...
      case NODE_MONITOR_ADDRESS:
        if (value == null) {
          ...
          setNodeMonitorAddress((ch.epfl.eagle.thrift.THostPort)value);
        }
        break;

      case OLD_NODE_MONITOR_ADDRESS:
        if (value == null) {
          unsetOldNodeMonitorAddress();
        } else {
          setOldNodeMonitorAddress((ch.epfl.eagle.thrift.THostPort)value);
        }
        break;
    ...
    public Object getFieldValue(_Fields field) {
      ...
      case OLD_NODE_MONITOR_ADDRESS:
        return getOldNodeMonitorAddress();
    ...
    public boolean isSet(_Fields field) {
      ...
      case OLD_NODE_MONITOR_ADDRESS:
        return isSetOldNodeMonitorAddress();
      }
      throw new IllegalStateException();
    }
    ...
    public boolean equals(getTask_args that) {
      ...
      boolean this_present_oldNodeMonitorAddress = true && this.isSetOldNodeMonitorAddress();
      boolean that_present_oldNodeMonitorAddress = true && that.isSetOldNodeMonitorAddress();
      if (this_present_oldNodeMonitorAddress || that_present_oldNodeMonitorAddress) {
        if (!(this_present_oldNodeMonitorAddress && that_present_oldNodeMonitorAddress))
          return false;
        if (!this.oldNodeMonitorAddress.equals(that.oldNodeMonitorAddress))
          return false;
      }
    ...
    public int hashCode() {
      ...
      boolean present_oldNodeMonitorAddress = true && (isSetOldNodeMonitorAddress());
      list.add(present_oldNodeMonitorAddress);
      if (present_oldNodeMonitorAddress)
        list.add(oldNodeMonitorAddress);
    ...
    public int compareTo(getTask_args other) {
      ...
      lastComparison = Boolean.valueOf(isSetOldNodeMonitorAddress()).compareTo(other.isSetOldNodeMonitorAddress());
      if (lastComparison != 0) {
        return lastComparison;
      }
      if (isSetOldNodeMonitorAddress()) {
        lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.oldNodeMonitorAddress, other.oldNodeMonitorAddress);
        if (lastComparison != 0) {
          return lastComparison;
        }
      }
    ...
    public String toString() {
      ...
      first = false;
      if (!first) sb.append(", ");
      sb.append("oldNodeMonitorAddress:");
      if (this.oldNodeMonitorAddress == null) {
        sb.append("null");
      } else {
        sb.append(this.oldNodeMonitorAddress);
      }
      first = false;
      sb.append(")");
      return sb.toString();
    ...
    public void validate() throws org.apache.thrift.TException {
      ...
      if (oldNodeMonitorAddress != null) {
        oldNodeMonitorAddress.validate();
      }
    }
    ...
    private static class getTask_argsStandardScheme extends StandardScheme<getTask_args> {
          ...
          switch (schemeField.id) {
            ...
            case 2: // NODE_MONITOR_ADDRESS
              if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
                struct.nodeMonitorAddress = new ch.epfl.eagle.thrift.THostPort();
            ...
            case 3: // OLD_NODE_MONITOR_ADDRESS
              if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
                struct.oldNodeMonitorAddress = new ch.epfl.eagle.thrift.THostPort();
                struct.oldNodeMonitorAddress.read(iprot);
                struct.setOldNodeMonitorAddressIsSet(true);
              } else { 
                org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
              }
              break;
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, getTask_args struct) throws org.apache.thrift.TException {
        ...
        if (struct.oldNodeMonitorAddress != null) {
          oprot.writeFieldBegin(OLD_NODE_MONITOR_ADDRESS_FIELD_DESC);
          struct.oldNodeMonitorAddress.write(oprot);
          oprot.writeFieldEnd();
        }
    ...
    private static class getTask_argsTupleScheme extends TupleScheme<getTask_args> {
      ...
      public void write(org.apache.thrift.protocol.TProtocol prot, getTask_args struct) throws org.apache.thrift.TException {
        ...
        if (struct.isSetOldNodeMonitorAddress()) {
          optionals.set(2);
        }
  ...
  public static class getTask_result implements org.apache.thrift.TBase<getTask_result, getTask_result._Fields>, java.io.Serializable, Cloneable, Comparable<getTask_result>   {
    ...
    public List<ch.epfl.eagle.thrift.TTaskLaunchSpec> success; // required
    ...
    static {
      ...
      tmpMap.put(_Fields.SUCCESS, new org.apache.thrift.meta_data.FieldMetaData("success", org.apache.thrift.TFieldRequirementType.DEFAULT, 
          new org.apache.thrift.meta_data.ListMetaData(org.apache.thrift.protocol.TType.LIST, 
              new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, ch.epfl.eagle.thrift.TTaskLaunchSpec.class))));
      metaDataMap = Collections.unmodifiableMap(tmpMap);
    ...
    public getTask_result(
      List<ch.epfl.eagle.thrift.TTaskLaunchSpec> success)
    {
      this();
    ...
    public getTask_result(getTask_result other) {
      if (other.isSetSuccess()) {
        List<ch.epfl.eagle.thrift.TTaskLaunchSpec> __this__success = new ArrayList<ch.epfl.eagle.thrift.TTaskLaunchSpec>(other.success.size());
        for (ch.epfl.eagle.thrift.TTaskLaunchSpec other_element : other.success) {
          __this__success.add(new ch.epfl.eagle.thrift.TTaskLaunchSpec(other_element));
        }
    ...
    public java.util.Iterator<ch.epfl.eagle.thrift.TTaskLaunchSpec> getSuccessIterator() {
      return (this.success == null) ? null : this.success.iterator();
    }

    public void addToSuccess(ch.epfl.eagle.thrift.TTaskLaunchSpec elem) {
      if (this.success == null) {
        this.success = new ArrayList<ch.epfl.eagle.thrift.TTaskLaunchSpec>();
      }
      this.success.add(elem);
    }

    public List<ch.epfl.eagle.thrift.TTaskLaunchSpec> getSuccess() {
      return this.success;
    }

    public getTask_result setSuccess(List<ch.epfl.eagle.thrift.TTaskLaunchSpec> success) {
      this.success = success;
      return this;
    }
    ...
    public void setFieldValue(_Fields field, Object value) {
      ...
      case SUCCESS:
        if (value == null) {
          ...
          setSuccess((List<ch.epfl.eagle.thrift.TTaskLaunchSpec>)value);
        }
        break;
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.success = new ArrayList<ch.epfl.eagle.thrift.TTaskLaunchSpec>(_list0.size);
                  ch.epfl.eagle.thrift.TTaskLaunchSpec _elem1;
                  for (int _i2 = 0; _i2 < _list0.size; ++_i2)
                  {
                    _elem1 = new ch.epfl.eagle.thrift.TTaskLaunchSpec();
                    _elem1.read(iprot);
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, getTask_result struct) throws org.apache.thrift.TException {
        ...
        if (struct.success != null) {
          oprot.writeFieldBegin(SUCCESS_FIELD_DESC);
          {
            ...
            for (ch.epfl.eagle.thrift.TTaskLaunchSpec _iter3 : struct.success)
            {
              _iter3.write(oprot);
            }
            oprot.writeListEnd();
        ...
        if (struct.isSetSuccess()) {
          {
            ...
            for (ch.epfl.eagle.thrift.TTaskLaunchSpec _iter4 : struct.success)
            {
              _iter4.write(oprot);
            }
          }
        ...
        if (incoming.get(0)) {
          {
            ...
            struct.success = new ArrayList<ch.epfl.eagle.thrift.TTaskLaunchSpec>(_list5.size);
            ch.epfl.eagle.thrift.TTaskLaunchSpec _elem6;
            for (int _i7 = 0; _i7 < _list5.size; ++_i7)
            {
              _elem6 = new ch.epfl.eagle.thrift.TTaskLaunchSpec();
              _elem6.read(iprot);
