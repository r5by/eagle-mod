...
public class NodeMonitorService {
  ...
  public interface Iface {
    ...
    public void tasksFinished(List<ch.epfl.eagle.thrift.TFullTaskId> tasks) throws org.apache.thrift.TException;
  ...
  public interface AsyncIface {
    ...
    public void tasksFinished(List<ch.epfl.eagle.thrift.TFullTaskId> tasks, org.apache.thrift.async.AsyncMethodCallback resultHandler) throws org.apache.thrift.TException;
  ...
  public static class Client extends org.apache.thrift.TServiceClient implements Iface {
    ...
    public void send_tasksFinished(List<ch.epfl.eagle.thrift.TFullTaskId> tasks) throws org.apache.thrift.TException
    {
  ...
  public static class AsyncClient extends org.apache.thrift.async.TAsyncClient implements AsyncIface {
    ...
    public static class tasksFinished_call extends org.apache.thrift.async.TAsyncMethodCall {
      private List<ch.epfl.eagle.thrift.TFullTaskId> tasks;
      public tasksFinished_call(List<ch.epfl.eagle.thrift.TFullTaskId> tasks, org.apache.thrift.async.AsyncMethodCallback resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
        super(client, protocolFactory, transport, resultHandler, false);
        this.tasks = tasks;
      }
  ...
  public static class tasksFinished_args implements org.apache.thrift.TBase<tasksFinished_args, tasksFinished_args._Fields>, java.io.Serializable, Cloneable, Comparable<tasksFinished_args>   {
    ...
    public List<ch.epfl.eagle.thrift.TFullTaskId> tasks; // required
    ...
    public tasksFinished_args(
      List<ch.epfl.eagle.thrift.TFullTaskId> tasks)
    {
      this();
      this.tasks = tasks;
    }
    ...
    public tasksFinished_args(tasksFinished_args other) {
      if (other.isSetTasks()) {
        List<ch.epfl.eagle.thrift.TFullTaskId> __this__tasks = new ArrayList<ch.epfl.eagle.thrift.TFullTaskId>(other.tasks.size());
        for (ch.epfl.eagle.thrift.TFullTaskId other_element : other.tasks) {
          __this__tasks.add(new ch.epfl.eagle.thrift.TFullTaskId(other_element));
        }
    ...
    public java.util.Iterator<ch.epfl.eagle.thrift.TFullTaskId> getTasksIterator() {
      return (this.tasks == null) ? null : this.tasks.iterator();
    }

    public void addToTasks(ch.epfl.eagle.thrift.TFullTaskId elem) {
      if (this.tasks == null) {
        this.tasks = new ArrayList<ch.epfl.eagle.thrift.TFullTaskId>();
      }
      this.tasks.add(elem);
    }

    public List<ch.epfl.eagle.thrift.TFullTaskId> getTasks() {
      return this.tasks;
    }

    public tasksFinished_args setTasks(List<ch.epfl.eagle.thrift.TFullTaskId> tasks) {
      this.tasks = tasks;
      return this;
    }
    ...
    public void setFieldValue(_Fields field, Object value) {
      ...
      case TASKS:
        if (value == null) {
          ...
          setTasks((List<ch.epfl.eagle.thrift.TFullTaskId>)value);
        }
        break;
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.tasks = new ArrayList<ch.epfl.eagle.thrift.TFullTaskId>(_list8.size);
                  ch.epfl.eagle.thrift.TFullTaskId _elem9;
                  for (int _i10 = 0; _i10 < _list8.size; ++_i10)
                  {
                    _elem9 = new ch.epfl.eagle.thrift.TFullTaskId();
                    _elem9.read(iprot);
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, tasksFinished_args struct) throws org.apache.thrift.TException {
        ...
        if (struct.tasks != null) {
          oprot.writeFieldBegin(TASKS_FIELD_DESC);
          {
            ...
            for (ch.epfl.eagle.thrift.TFullTaskId _iter11 : struct.tasks)
            {
              _iter11.write(oprot);
            }
            oprot.writeListEnd();
        ...
        if (struct.isSetTasks()) {
          {
            ...
            for (ch.epfl.eagle.thrift.TFullTaskId _iter12 : struct.tasks)
            {
              _iter12.write(oprot);
            }
          }
        ...
        if (incoming.get(0)) {
          {
            ...
            struct.tasks = new ArrayList<ch.epfl.eagle.thrift.TFullTaskId>(_list13.size);
            ch.epfl.eagle.thrift.TFullTaskId _elem14;
            for (int _i15 = 0; _i15 < _list13.size; ++_i15)
            {
              _elem14 = new ch.epfl.eagle.thrift.TFullTaskId();
              _elem14.read(iprot);
